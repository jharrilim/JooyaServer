...
{
    public sealed class DeflateWriteStream : WebSocketMessageWriteStream
    {
        private static readonly byte[] FinalByte = { 0 };
        ...
        public DeflateWriteStream(WebSocketMessageWriteStream inner)
        {
            _inner = inner;
